...
public class ExerciseListRecyclerViewAdapter extends RecyclerView.Adapter<ExerciseViewHolder> {

    private Context context;
    private List<Exercise> exerciseList;
    private DatabaseQueryClass databaseQueryClass;

    public ExerciseListRecyclerViewAdapter(Context context, List<Exercise> exerciseList) {
...
//        holder.registrationNumTextView.setText(String.valueOf(exercise.getRegistrationNumber()));
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), displayGraph.class);
